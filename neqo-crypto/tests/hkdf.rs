...
fn extract_sha256() {
    extract(
        ...
        &[
            0xa5, 0x68, 0x02, 0x5a, 0x95, 0xc9, 0x7f, 0x55, 0x38, 0xbc, 0xf7, 0x97, 0xcc, 0x0f,
            0xd5, 0xf6, 0xa8, 0x8d, 0x15, 0xbc, 0x0e, 0x85, 0x74, 0x70, 0x3c, 0xa3, 0x65, 0xbd,
            0x76, 0xcf, 0x9f, 0xd3,
        ],
    );
    extract(
...
fn derive_secret(cipher: Cipher, expected: &[u8]) {
    ...
    let secret = hkdf::derive_secret(TLS_VERSION_1_3, cipher, &prk, "master secret")
...
fn derive_secret_sha256() {
    derive_secret(
        TLS_AES_128_GCM_SHA256,
        &[
            0xb7, 0x08, 0x00, 0xe3, 0x8e, 0x48, 0x68, 0x91, 0xb1, 0x0f, 0x5e, 0x6f, 0x22, 0x53,
            0x6b, 0x84, 0x69, 0x75, 0xaa, 0xa3, 0x2a, 0xe7, 0xde, 0xaa, 0xc3, 0xd1, 0xb4, 0x05,
            0x22, 0x5c, 0x68, 0xf5,
        ],
    );
    derive_secret(
