...
fn make_client() {
    fixture_init();
    let _c = Client::new("server", false).expect("should create client");
}
...
fn resume() {
    ...
    let mut client = Client::new("server.example", false).expect("should create second client");
