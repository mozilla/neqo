...
client)
  ...
  RUST_LOG=debug RUST_BACKTRACE=1 neqo-client --verbose --cc cubic --qns-test "$TESTCASE" \
...
server)
  ...
  RUST_LOG=info RUST_BACKTRACE=1 neqo-server --verbose --cc cubic --qns-test "$TESTCASE" \
