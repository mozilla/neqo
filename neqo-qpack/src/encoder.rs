...
mod tests {
    ...
    fn test_header_block_encoder_non() {
        let test_cases: [TestElement; 6] = [
            ...
            TestElement {
                headers: vec![Header(String::from(":method"), String::from("GET"))],
                header_block: &[0x00, 0x00, 0xd1],
                encoder_inst: &[],
            },
            // test encode_literal_with_name_ref
            TestElement {
                headers: vec![Header(String::from(":path"), String::from("/somewhere"))],
                header_block: &[
            ...
            TestElement {
                headers: vec![Header(String::from("my-header"), String::from("my-value"))],
            ...
            // test encode_literal_with_name_ref.
            TestElement {
                headers: vec![Header(String::from("my-header"), String::from("my-value2"))],
                header_block: &[
            ...
            TestElement {
                headers: vec![
                    ...
                    Header(String::from(":path"), String::from("/somewhere")),
                    Header(String::from(":authority"), String::from("example.com")),
    ...
    fn max_block_streams3() {
        ...
        let buf = encoder
            ...
            .encode_header_block(
                &mut encoder.conn,
                &[Header(String::from("name1"), String::from("value1"))],
                1,
            )
            .unwrap();
        ...
        let buf = encoder
            ...
            .encode_header_block(
                &mut encoder.conn,
                &[Header(String::from("name2"), String::from("value2"))],
                2,
            )
            .unwrap();
    ...
    fn encoder_flow_controlled_blocked() {
        ...
        let buf1 = encoder
            ...
            .encode_header_block(
                &mut encoder.conn,
                &[
                    Header(String::from("something"), String::from("1234")),
                    Header(String::from("something2"), String::from("12345678910")),
                ],
                1,
            )
            .unwrap();
        ...
        let buf2 = encoder
            ...
            .encode_header_block(
                &mut encoder.conn,
                &[
                    Header(String::from("something3"), String::from("1234")),
                    Header(String::from("something4"), String::from("12345678910")),
                ],
                2,
            )
            .unwrap();
        ...
        let buf3 = encoder
            ...
            .encode_header_block(
                &mut encoder.conn,
                &[
                    Header(String::from("something5"), String::from("1234")),
                    Header(String::from("something6"), String::from("12345678910")),
                ],
                3,
            )
            .unwrap();
    ...
    fn test_do_not_evict_entry_that_are_referd_only_by_the_same_header_blocked_encoding() {
        ...
        assert!(encoder
            ...
            .encode_header_block(
                ...
                &[
                    Header(String::from("something5"), String::from("1234")),
                    Header(String::from("something6"), String::from("1234")),
                ],
                3,
            )
            .is_ok());
