...
#[cfg(feature = "qlog")]
use crate::qlog;
use crate::{packet, recovery::sent, rtt::RttEstimate, sender::PACING_BURST_SIZE, Pmtud};
...
impl<T: WindowAdjustment> ClassicCongestionControl<T> {
    #[cfg_attr(
        ...
        expect(
            ...
            reason = "Can't be const with qlog enabled"
        )
    )]
