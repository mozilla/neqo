...
mod tests {
    ...
    fn stream_tx() {
        ...
        let mut s = SendStream::new(4.into(), 1024, Rc::clone(&conn_fc), conn_events, tx_buffer_pool());
    ...
    fn send_stream_writable_event_gen() {
        ...
        let mut s = SendStream::new(4.into(), 0, Rc::clone(&conn_fc), conn_events.clone(), tx_buffer_pool());
    ...
    fn send_stream_writable_event_new_stream() {
        ...
        let _s = SendStream::new(4.into(), 100, conn_fc, conn_events.clone(), tx_buffer_pool());
    ...
    fn data_blocked() {
        ...
        let mut s = SendStream::new(stream_id, 2, Rc::clone(&conn_fc), conn_events, tx_buffer_pool());
    ...
    fn ack_fin_first() {
        ...
        let mut s = SendStream::new(StreamId::new(100), 0, conn_fc, conn_events, tx_buffer_pool());
