...
///
/// TODO: We could use <https://docs.rs/rand/latest/rand/seq/trait.SliceRandom.html#tymethod.shuffle>
/// instead, but I assume we want to only use the NSS RNG in neqo?
