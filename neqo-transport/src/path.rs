...
use neqo_common::{hex, qdebug, qinfo, qlog::NeqoQlog, qtrace, qwarn, DatagramTrain, Encoder, IpTos};
...
impl Path {
    ...
    pub fn datagram_train(
        ...
        DatagramTrain {src: self.local, dst: self.remote, tos: tos, segment_size, d: payload}
    }
