...
///
/// Deliberately has no `Sent` or `Expired` variant: unlike `Dropped`, a
/// tracked datagram being sent or aging out has no per-datagram detail worth
/// reporting beyond the aggregate sent/expired counters, which cover tracked
/// and untracked datagrams alike.
