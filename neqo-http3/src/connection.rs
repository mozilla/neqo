...
impl Http3Connection {
        ...
        self.recv_streams
            ...
            .filter_map(|(id, s)| {
                s.extended_connect_session().and_then(|sess| {
                    (sess.borrow().connect_type() == ExtendedConnectType::WebTransport)
                        .then_some(*id)
                })
            })
            .collect()
    ...
    fn extended_connect_set_datagram_max_age(
        &mut self,
        session_id: StreamId,
        age_ms: f64,
    ...
    pub fn webtransport_set_datagram_high_water_mark(
        ...
        self.extended_connect_set_datagram_high_water_mark(session_id, mark)
    }
