...
impl Http3ServerHandler {
    ...
    ///
    /// Only used in tests to simulate the server initiating connection shutdown.
    #[cfg(test)]
    pub fn test_queue_goaway(&mut self, stream_id: StreamId) {
        self.base_handler
    ...
    pub fn test_wt_drain_session(
        ...
        self.needs_processing = true;
        self.base_handler.test_wt_drain_session(conn, session_id, now)
    }
